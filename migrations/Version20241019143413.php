 ...
 */
final class Version20241019143413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C12B8A649A FOREIGN KEY (grand_parent_id) REFERENCES category (id)');
